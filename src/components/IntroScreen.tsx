...
export const IntroScreen: React.FC<IntroScreenProps> = ({ onComplete }) => {
  ...
  }, [showTyping, onComplete]);const helloWords = [
    { 
      text: "Hello", 
      color: "#ffffff", 
      style: { 
  ...
  return (
    ...
    >      {/* Clean Apple-like background */}
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        <div className="relative mb-8">
          {showTyping && (
            <div className="text-6xl md:text-8xl lg:text-9xl xl:text-[12rem] font-light tracking-normal leading-none">
              <div className="text-white drop-shadow-2xl" style={{ 
        ...
        </div>        {/* Enhanced subtitle with Apple-like simplicity */}
        <div
        ...
        >
          <span className="text-gray-300">
            I'm Ahmed Ayman Alhofy
          </span>
        </div>        {/* Simple Apple-like loading animation */}
        <div
        ...
        >
          ...
          <div className="w-2 h-2 bg-white/60 rounded-full animate-pulse delay-400"></div>        </div>
      </div>
    </div>
  );
};
