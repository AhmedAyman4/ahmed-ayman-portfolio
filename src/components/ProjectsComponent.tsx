...
const ProjectCard = ({ project }) => (
  <div
    className="aspect-square bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2 p-6 flex flex-col fade-in-section border-t-4"
    style={{ borderColor: "hsl(var(--primary))" }}
  >
    {/* </div><div className="aspect-square bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2 p-6 flex flex-col fade-in-section"> */}
    ...
    <p className="text-sm mt-2 text-gray-600 dark:text-gray-300 flex-grow line-clamp-4">
      {project.description}
    </p>
